...
public class Hobbin extends AbstractEnemy {
	...
	public void move() {
		...
		if (Math.abs(xDistance) > Math.abs(yDistance)) {
			if (xDistance > 0 && world.getLevel()[this.yLoc][this.xLoc + 1] != 10) {
		...
		if (Math.abs(xDistance) < Math.abs(yDistance)) {
			if (yDistance > 0 && world.getLevel()[this.yLoc + 1][this.xLoc] != 10) {
				world.getLevel()[this.yLoc][this.xLoc] = 0;
				this.yLoc++;
				if (world.getLevel()[this.yLoc][this.xLoc] == 2) {
					world.subtractEmerald();
		...
		if (this.yLoc - 1 >= 0
				&& world.getLevel()[this.yLoc - 1][this.xLoc] == 0 && world.getLevel()[this.yLoc - 1][this.xLoc] != 10) {
			world.getLevel()[this.yLoc][this.xLoc] = 0;
			this.yLoc--;
			world.getLevel()[this.yLoc][this.xLoc] = 4;
			if (world.player.xLoc == this.xLoc
		...
		if (this.xLoc + 1 < world.getLevel()[this.yLoc].length
				&& world.getLevel()[this.yLoc][this.xLoc + 1] == 0 && world.getLevel()[this.yLoc][this.xLoc + 1] != 10) {
			world.getLevel()[this.yLoc][this.xLoc] = 0;
			this.xLoc++;
			world.getLevel()[this.yLoc][this.xLoc] = 4;
			if (world.player.xLoc == this.xLoc
